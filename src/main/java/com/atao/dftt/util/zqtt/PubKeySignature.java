...
public class PubKeySignature {
	 ...
	 */
	public static String publicKey = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAguBri-pCOaaGyotA2l_SmHM32WEbOqSmUuPqIeQYGtV15QZqQhFmK2zL-FKnTuISZeq09hiHifg4CrpnygM8wJ19obbECvNBkc1qYTDoknWwhmqO6dtEC_aeTqGv3joR5IMG0aqy0Q9PE5fxDQCaNtN5BZgJf-gGUWuoQ8zRoKpjXhnKKFtsPhmbUWIldZtVjM9dqXeDVXxnk52qyeWGdbof_0ZWfbtIj8npUsbHn3nLx91Fc73_ah533C2iFUhGQrw2iEGISZ0eIZmeGYQnfKizfH1QhVsQUCnA9tojzeowc6Cyrd06HPjSZFH8RLv4dBj0YlmC2wFUySXrwkcloQIDAQAB";
	public static String a(char arg3) {
		String v4 = publicKey.substring(9, publicKey.length());
		String v0 = v4.substring(0, v4.length() - 5);
		v4 = v0.substring(v0.length() - 36);
		String v5_1 = v4.substring(0, v4.length() - arg3 % 10);
        return v5_1;
	}
