 ...
 * @author twang
 */
public class ZqttUser extends BaseEntity {
    ...
    */
     ...
     * 
     */
    @Column(name = "zqkey_id")
    private String zqkeyId;
    /**
     * 
     */
    @Column(name = "zqkey")
    private String zqkey;
    /**
     * 
     */
    ...
    public void setZqkeyId(String zqkeyId) {
        this.zqkeyId = zqkeyId;
    }
    public String getZqkey() {
        return zqkey;
    }

    public void setZqkey(String zqkey) {
        this.zqkey = zqkey;
    }
    ...
    public static class TF {
        ...
        public static String TABLE_NAME = "ZQTT_USER";   // 表名
        ...
        public static String zqkeyId = "zqkey_id";  // 
        public static String zqkey = "zqkey";  // 
